...
format:
  html:
    bootswatch: cosmo          # or any other you like: cerulean, journal, yeti…
    primary: "#4682B4"            # steelblue
    secondary: "#B22222"          # firebrick
    success: "#444444"            # dark gray for body text
    toc: true
    toc_depth: 2
    toc_float: true
    ...
    code_folding: hide
    code_download: TRUE
    code_download_name: "analysis.R"
    code_summary: "Show/hide code"
    fig_caption: true
    highlight: kate
    df_print: paged
---
